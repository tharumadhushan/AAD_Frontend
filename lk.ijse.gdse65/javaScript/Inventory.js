...
loadAllItemCode();
    ...
    function callMethod() {
        $("#inventory-tbl-body").on("click", "tr", function () {
            ...
            let statuss = $(this).children().eq(10).text();
    ...
    $("#save_employee").click(function () {
        ...
        formData.append("category", $("#status").val());
        formData.append("size", $("#designation").val());
        formData.append("unit_price_sale", $("#emp_role").val());
        formData.append("unit_price_buy", $("#emp_dob").val());
        formData.append("expected_profit", $("#emp_joindate").val());
        formData.append("profit_margin", $("#attachedBranch").val());
        formData.append("status", $("#employeeAddress1").val());
    ...
    $("#update_inventory").click(function () {
        let formData = {
            ...
            statuss: $("#statuss").val(), // Corrected ID
        };
